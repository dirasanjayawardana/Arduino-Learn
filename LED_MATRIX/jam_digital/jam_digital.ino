...
// pin 11 ke DIN Modul Dot Matrix MAX7219
// pin 10 ke CS Modul Dot Matrix MAX7219
// pin 13 ke CLK  Modul Dot Matrix MAX7219
LedControl lc = LedControl(11, 13, 10, 4); //sets the 3 pins as 12, 11 & 10 and then sets 4 displays (max is 8 displays)

//global variables
byte intensity = 7;                      // Kecerahan Display (0-15)
byte clock_mode = 0;                     // Mode Dasar. Default = 0 (basic_mode)
